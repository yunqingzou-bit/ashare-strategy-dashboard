...
js = '''(function(){
  function setup(tbl){
    ...
    var dsum=tbl.getAttribute('data-sum');
    if(dsum){ apply(); var id2=tbl.getAttribute('data-cnt'), el2=id2?document.getElementById(id2):null;
      var rows2=rows, ctrls2=ctrls;
      ctrls2.forEach?null:null; }
    apply();
  }
